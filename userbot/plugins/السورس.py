...
.𓄌 : ping  {ping}  𓇡.
.𓄌 : version 7.4  𓇡.
.𓄌 : Source TelethonArab : @uui9u  𓇡."""
@iqthon.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))    
async def source(e):
    await edit_or_reply(e, "https://github.com/TeleOniOn/TelethonArab",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون السلطان - Telethon-Arabe ، 🕸  ❭ :"
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⎈ ⦙  📑 يرجى متابع قناه الفارات تجدها هنا : @uui9u")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://youtu.be/44tYK_yV02Q"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/Telethon-helper/Help"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/ninn2"),]]
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**⎈ ⦙ قـائمـه الاوامـر :**\n**⎈ ⦙ قنـاه السـورس :** @uui9u\n**⎈ ⦙ شـرح اوامـر السـورس : @FFF20KKK**\n**⎈ ⦙ شـرح فـارات السـورس : @FFF20KKK** "
