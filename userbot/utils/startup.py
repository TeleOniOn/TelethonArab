...
LOGS = logging.getLogger("تليثون السلطان\n ")
...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/ec7b698b4f2f821421169.mp4", caption="**⎈ ⦙ تـمّ تـحديـث تليثـون السلطان ✓  :**  [ 7.4 ] \n \n**⎈ ⦙ للحصول على اوامر السورس أرسل :** (  `.الاوامر`  ) \n**⎈ ⦙ يحتاج لتفعيل اونلاين أو أرسل :** (  `.اوامري`  )\n\n**⎈ ⦙ القناة الرسمية : @UUI9U **\n**⎈ ⦙ فارات سورس تليثون  : @EECFE **\n**⎈ ⦙ كلايش تليثون :  @EECFEEE**",                buttons=[(Button.url("مجموعه تليثون", "https://t.me/EECFEEE"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
